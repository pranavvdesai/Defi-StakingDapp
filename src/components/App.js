...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    // const networkData = NetworkData.find(n => n.id === networkId);
    console.log(networkId); //5777
    
    // this.setState({ network: networkData.name });
    // Load contract
    ...
    //   networkContract
    // );
    // const networkContractData = await networkContractInstance.methods
    //   .getNetworkData()
    //   .call();
    // this.setState({
